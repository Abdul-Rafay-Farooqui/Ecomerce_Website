  ...
  return (
    <Grid container spacing={2} p={2} mt={1}>
        ...
        <Grid item xs={6}>
            ...
            <Card className='cards' sx={{ maxWidth: 700 , padding: 0, backgroundColor: "#242424" , boxShadow: "rgba(0, 0, 0, 0.07) 0px 1px 2px, rgba(0, 0, 0, 0.07) 0px 2px 4px, rgba(0, 0, 0, 0.07) 0px 4px 8px, rgba(0, 0, 0, 0.07) 0px 8px 16px, rgba(0, 0, 0, 0.07) 0px 16px 32px, rgba(0, 0, 0, 0.07) 0px 32px 64px;" } }>
            <CardMedia
              sx={{  height: 200 }}
              image={card.picture}
              title="Card"
            ...
            <CardActions>
              <Button sx={{color: "#fff"}} size="small" color="inherit">See more</Button>
            </CardActions>
          </Card>
         </Link>
        </Grid>
